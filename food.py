...
class Food:
  ...
  def __init__(self, block_size, bounds): # sets the size and boundary space for the food
  ...
  def respawn(self): # takes random coordinates in grid and places food block there
